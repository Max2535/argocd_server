...
echo "   ./fix-installation.sh      - Fix installation issues"
echo "   ./fix-502-gateway.sh       - Fix 502 Bad Gateway errors"
echo "   ./join-cluster-guide.sh    - Guide to join Kubernetes cluster"
echo "   ./join-kind-cluster.sh     - Auto join kind cluster client"
echo ""
